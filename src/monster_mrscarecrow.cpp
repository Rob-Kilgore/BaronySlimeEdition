/*-------------------------------------------------------------------------------
	...
	BARONY
	File: monster_mrscarecrow.cpp
	Desc: implements all of the mrscarecrow monster's code
...
void initMrScarecrow(Entity* my, Stat* myStats)
{
	...
	//Sprite 1552 = MrScarecrow head model.
	my->initMonster(1552);
			...
			else
			{
				...
				switch (rand() % 2)
				{
					case 0:					//The Potato King
						...
						for (c = 0; c < 3; c++)
						{
							Entity* entity = summonMonster(MR_SCARECROW, my->x, my->y);
							if (entity)
							{
	...
	// torso
	Entity* entity = newEntity(1553, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	...
	entity->focalx = limbs[MR_SCARECROW][1][0]; // 0
	entity->focaly = limbs[MR_SCARECROW][1][1]; // 0
	entity->focalz = limbs[MR_SCARECROW][1][2]; // 0
	entity->behavior = &actMrScarecrowLimb;
	entity->parent = my->getUID();
	...
	// right leg
	entity = newEntity(1557, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[MR_SCARECROW][2][0]; // 0
	entity->focaly = limbs[MR_SCARECROW][2][1]; // 0
	entity->focalz = limbs[MR_SCARECROW][2][2]; // 2
	entity->behavior = &actMrScarecrowLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	// left leg
	entity = newEntity(1556, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[MR_SCARECROW][3][0]; // 0
	entity->focaly = limbs[MR_SCARECROW][3][1]; // 0
	entity->focalz = limbs[MR_SCARECROW][3][2]; // 2
	entity->behavior = &actMrScarecrowLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	// right arm
	entity = newEntity(1555, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[MR_SCARECROW][4][0]; // 0
	entity->focaly = limbs[MR_SCARECROW][4][1]; // 0
	entity->focalz = limbs[MR_SCARECROW][4][2]; // 1.5
	entity->behavior = &actMrScarecrowLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	// left arm
	entity = newEntity(1554, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[MR_SCARECROW][5][0]; // 0
	entity->focaly = limbs[MR_SCARECROW][5][1]; // 0
	entity->focalz = limbs[MR_SCARECROW][5][2]; // 1.5
	entity->behavior = &actMrScarecrowLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[MR_SCARECROW][6][0]; // 1.5
	entity->focaly = limbs[MR_SCARECROW][6][1]; // 0
	entity->focalz = limbs[MR_SCARECROW][6][2]; // -.5
	entity->behavior = &actMrScarecrowLimb;
	entity->parent = my->getUID();
	entity->pitch = .25;
	node = list_AddNodeLast(&my->children);
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[MR_SCARECROW][7][0]; // 2
	entity->focaly = limbs[MR_SCARECROW][7][1]; // 0
	entity->focalz = limbs[MR_SCARECROW][7][2]; // 0
	entity->behavior = &actMrScarecrowLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[MR_SCARECROW][8][0]; // 0
	entity->focaly = limbs[MR_SCARECROW][8][1]; // 0
	entity->focalz = limbs[MR_SCARECROW][8][2]; // 4
	entity->behavior = &actMrScarecrowLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[MR_SCARECROW][9][0]; // 0
	entity->focaly = limbs[MR_SCARECROW][9][1]; // 0
	entity->focalz = limbs[MR_SCARECROW][9][2]; // -2
	entity->behavior = &actMrScarecrowLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[MR_SCARECROW][10][0]; // 0
	entity->focaly = limbs[MR_SCARECROW][10][1]; // 0
	entity->focalz = limbs[MR_SCARECROW][10][2]; // .25
	entity->behavior = &actMrScarecrowLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
...
#define MR_SCARECROWWALKSPEED .13
...
void mrscarecrowMoveBodyparts(Entity* my, Stat* myStats, double dist)
{
	...
	for (bodypart = 0, node = my->children.first; node != nullptr; node = node->next, bodypart++)
	{
		...
		{
			my->humanoidAnimateWalk(entity, node, bodypart, MR_SCARECROWWALKSPEED, dist, 0.4);
		}
		...
		switch ( bodypart )
		{
			...
			case LIMB_HUMANOID_TORSO:
				...
				my->setHumanoidLimbOffset(entity, MR_SCARECROW, LIMB_HUMANOID_TORSO);
				break;
			// right leg
			case LIMB_HUMANOID_RIGHTLEG:
				...
				my->setHumanoidLimbOffset(entity, MR_SCARECROW, LIMB_HUMANOID_RIGHTLEG);
				break;
			// left leg
			case LIMB_HUMANOID_LEFTLEG:
				...
				my->setHumanoidLimbOffset(entity, MR_SCARECROW, LIMB_HUMANOID_LEFTLEG);
				break;
			// right arm
			case LIMB_HUMANOID_RIGHTARM:
			{
				...
				if ( weaponNode )
				{
					...
					if ( MONSTER_ARMBENDED || (weapon->flags[INVISIBLE] && my->monsterState == MONSTER_STATE_WAIT) )
					{
						...
						entity->focalx = limbs[MR_SCARECROW][4][0]; // 0
						entity->focaly = limbs[MR_SCARECROW][4][1]; // 0
						entity->focalz = limbs[MR_SCARECROW][4][2]; // 2
						entity->sprite = 178;
					}
					else
					{
						// else flex arm.
						entity->focalx = limbs[MR_SCARECROW][4][0] + 0.75;
						entity->focaly = limbs[MR_SCARECROW][4][1];
						entity->focalz = limbs[MR_SCARECROW][4][2] - 0.75;
						entity->sprite = 179;
					}
				}
				my->setHumanoidLimbOffset(entity, MR_SCARECROW, LIMB_HUMANOID_RIGHTARM);
			...
			case LIMB_HUMANOID_LEFTARM:
			{
				...
				if ( shieldNode )
				{
					...
					if ( shield->flags[INVISIBLE] && my->monsterState == MONSTER_STATE_WAIT )
					{
						entity->focalx = limbs[MR_SCARECROW][5][0]; // 0
						entity->focaly = limbs[MR_SCARECROW][5][1]; // 0
						entity->focalz = limbs[MR_SCARECROW][5][2]; // 2
						entity->sprite = 176;
					}
					else
					{
						entity->focalx = limbs[MR_SCARECROW][5][0] + 0.75;
						entity->focaly = limbs[MR_SCARECROW][5][1];
						entity->focalz = limbs[MR_SCARECROW][5][2] - 0.75;
						entity->sprite = 177;
					}
				}
				my->setHumanoidLimbOffset(entity, MR_SCARECROW, LIMB_HUMANOID_LEFTARM);
			...
			case LIMB_HUMANOID_MASK:
				...
				if ( entity->sprite != 165 )
				{
					...
					{
						entity->focalx = limbs[MR_SCARECROW][10][0] + .35; // .35
						entity->focaly = limbs[MR_SCARECROW][10][1] - 2; // -2
						entity->focalz = limbs[MR_SCARECROW][10][2]; // .25
					}
				}
				else
				{
					entity->focalx = limbs[MR_SCARECROW][10][0] + .25; // .25
					entity->focaly = limbs[MR_SCARECROW][10][1] - 2.25; // -2.25
					entity->focalz = limbs[MR_SCARECROW][10][2]; // .25
				}
				break;
		}
