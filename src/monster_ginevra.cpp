/*-------------------------------------------------------------------------------
	...
	BARONY
	File: monster_ginevra.cpp
	Desc: implements all of the ginevra monster's code
...
void initGinevra(Entity* my, Stat* myStats)
{
	...
	//Sprite 1558 = ginevra head sprite
	my->initMonster(1558);
	...
	if ( multiplayer != CLIENT && !MONSTER_INIT )
	{
		if ( myStats != nullptr )
		{
			...
			else
			{
				...
				if ( !strncmp(myStats->name, "lesser ginevra", strlen("lesser ginevra")) )
				{
					lesserMonster = true;
					myStats->HP = 80;
					myStats->MAXHP = myStats->HP;
				...
				// always give special spell to ginevra, undroppable.
	...
	// torso
	Entity* entity = newEntity(1559, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	...
	entity->focalx = limbs[GINEVRA][1][0]; // 0
	entity->focaly = limbs[GINEVRA][1][1]; // 0
	entity->focalz = limbs[GINEVRA][1][2]; // 0
	entity->behavior = &actGinevraLimb;
	entity->parent = my->getUID();
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[GINEVRA][2][0]; // 1
	entity->focaly = limbs[GINEVRA][2][1]; // 0
	entity->focalz = limbs[GINEVRA][2][2]; // 2
	entity->behavior = &actGinevraLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[GINEVRA][3][0]; // 1
	entity->focaly = limbs[GINEVRA][3][1]; // 0
	entity->focalz = limbs[GINEVRA][3][2]; // 2
	entity->behavior = &actGinevraLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	*/
	// right arm
	entity = newEntity(1561, 0, map.entities, nullptr); //595 //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[GINEVRA][4][0]; // -.25
	entity->focaly = limbs[GINEVRA][4][1]; // 0
	entity->focalz = limbs[GINEVRA][4][2]; // 1.5
	entity->behavior = &actGinevraLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	// left arm
	entity = newEntity(1560, 0, map.entities, nullptr); //447 //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[GINEVRA][5][0]; // -.25
	entity->focaly = limbs[GINEVRA][5][1]; // 0
	entity->focalz = limbs[GINEVRA][5][2]; // 1.5
	entity->behavior = &actGinevraLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[GINEVRA][6][0]; // 
	entity->focaly = limbs[GINEVRA][6][1]; // 
	entity->focalz = limbs[GINEVRA][6][2]; // 
	entity->behavior = &actGinevraLimb;
	entity->parent = my->getUID();
	entity->pitch = .25;
	node = list_AddNodeLast(&my->children);
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[GINEVRA][7][0]; // 
	entity->focaly = limbs[GINEVRA][7][1]; // 
	entity->focalz = limbs[GINEVRA][7][2]; // 
	entity->behavior = &actGinevraLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[GINEVRA][8][0]; // 0
	entity->focaly = limbs[GINEVRA][8][1]; // 0
	entity->focalz = limbs[GINEVRA][8][2]; // 4
	entity->behavior = &actGinevraLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[INVISIBLE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[GINEVRA][9][0]; // 0
	entity->focaly = limbs[GINEVRA][9][1]; // 0
	entity->focalz = limbs[GINEVRA][9][2]; // -2
	entity->behavior = &actGinevraLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[INVISIBLE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[GINEVRA][10][0]; // 0
	entity->focaly = limbs[GINEVRA][10][1]; // 0
	entity->focalz = limbs[GINEVRA][10][2]; // .5
	entity->behavior = &actGinevraLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
...
void ginevraMoveBodyparts(Entity* my, Stat* myStats, double dist)
{
	...
	for (bodypart = 0, node = my->children.first; node != nullptr; node = node->next, bodypart++)
	{
		...
		if ( bodypart == LIMB_HUMANOID_RIGHTLEG || bodypart == LIMB_HUMANOID_LEFTARM )
		{
			...
			{
				my->humanoidAnimateWalk(entity, node, bodypart, GINEVRAWALKSPEED, dist, 0.4);
			}
		}
				...
				if ( my->monsterAttack > 0 )
				{
						...
						|| my->monsterAttack == MONSTER_POSE_HAG_TAUNT)
					{
						if ( my->monsterAttackTime == 0 )
						{
							...
							if ( multiplayer != CLIENT )
							{
								// set overshoot for head, freeze ginevra in place
		...
		switch ( bodypart )
		{
			...
			case LIMB_HUMANOID_TORSO:
				my->setHumanoidLimbOffset(entity, GINEVRA, LIMB_HUMANOID_TORSO);
				break;
			// right leg
			case LIMB_HUMANOID_RIGHTLEG:
				...
				my->setHumanoidLimbOffset(entity, GINEVRA, LIMB_HUMANOID_RIGHTLEG);
				break;
			// left leg
			case LIMB_HUMANOID_LEFTLEG:
				...
				my->setHumanoidLimbOffset(entity, GINEVRA, LIMB_HUMANOID_LEFTLEG);
				break;
			// right arm
			case LIMB_HUMANOID_RIGHTARM:
			{
				...
				if ( weaponNode )
				{
					...
					if ( MONSTER_ARMBENDED || (weapon->flags[INVISIBLE] && my->monsterState != MONSTER_STATE_ATTACK) )
					{
						...
						entity->focalx = limbs[GINEVRA][4][0] - 0.25; // 0
						entity->focaly = limbs[GINEVRA][4][1] - 0.25; // 0
						entity->focalz = limbs[GINEVRA][4][2]; // 2
						entity->sprite = 448;
						if ( my->monsterAttack == 0 )
						{
							entity->roll = -PI / 32;
					...
					{
						// else flex arm.
						entity->focalx = limbs[GINEVRA][4][0];
						entity->focaly = limbs[GINEVRA][4][1];
						entity->focalz = limbs[GINEVRA][4][2];
						entity->sprite = 595;
					}
				}
				my->setHumanoidLimbOffset(entity, GINEVRA, LIMB_HUMANOID_RIGHTARM);
			...
			case LIMB_HUMANOID_LEFTARM:
			{
				...
				if ( shieldNode )
				{
					...
					{
						// if weapon invisible and I'm not attacking, relax arm.
						entity->focalx = limbs[GINEVRA][5][0] - 0.25; // 0
						entity->focaly = limbs[GINEVRA][5][1] + 0.25; // 0
						entity->focalz = limbs[GINEVRA][5][2]; // 2
						entity->sprite = 447;
						if ( my->monsterAttack == 0 )
						{
							entity->roll = PI / 32;
					...
					{
						// else flex arm.
						entity->focalx = limbs[GINEVRA][5][0];
						entity->focaly = limbs[GINEVRA][5][1];
						entity->focalz = limbs[GINEVRA][5][2];
						entity->sprite = 594;
					}
				}
				my->setHumanoidLimbOffset(entity, GINEVRA, LIMB_HUMANOID_LEFTARM);
			...
			case LIMB_HUMANOID_MASK:
				...
				if ( entity->sprite != 165 )
				{
					...
					{
						entity->focalx = limbs[GINEVRA][10][0] + .35; // .35
						entity->focaly = limbs[GINEVRA][10][1] - 2; // -2
						entity->focalz = limbs[GINEVRA][10][2]; // .5
					}
				}
				else
				{
					entity->focalx = limbs[GINEVRA][10][0] + .25; // .25
					entity->focaly = limbs[GINEVRA][10][1] - 2.25; // -2.25
					entity->focalz = limbs[GINEVRA][10][2]; // .5
				}
				break;
			}
