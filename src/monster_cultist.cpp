/*-------------------------------------------------------------------------------
	...
	BARONY
	File: monster_cultist.cpp
	Desc: implements all of the cultist monster's code
...
void initCultist(Entity* my, Stat* myStats)
{
	...
	//Sprite 1570 = Cultist head model
	my->initMonster(1570);
	...
	if ( multiplayer != CLIENT && !MONSTER_INIT )
	{
		if ( myStats != nullptr )
		{
			...
			if ( !strncmp(myStats->name, "cultist cultist", 14) )
			{
				cultist = 1 + rand() % 2;
			}
	...
	// torso
	Entity* entity = newEntity(1571, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	...
	entity->focalx = limbs[CULTIST][1][0]; // 0
	entity->focaly = limbs[CULTIST][1][1]; // 0
	entity->focalz = limbs[CULTIST][1][2]; // 0
	entity->behavior = &actCultistLimb;
	...
	// right leg
	entity = newEntity(1575, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[CULTIST][2][0]; // .25
	entity->focaly = limbs[CULTIST][2][1]; // 0
	entity->focalz = limbs[CULTIST][2][2]; // 1.5
	entity->behavior = &actCultistLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	// left leg
	entity = newEntity(1574, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[CULTIST][3][0]; // .25
	entity->focaly = limbs[CULTIST][3][1]; // 0
	entity->focalz = limbs[CULTIST][3][2]; // 1.5
	entity->behavior = &actCultistLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	// right arm
	entity = newEntity(1573, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[CULTIST][4][0]; // 0
	entity->focaly = limbs[CULTIST][4][1]; // 0
	entity->focalz = limbs[CULTIST][4][2]; // 2
	entity->behavior = &actCultistLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	// left arm
	entity = newEntity(1572, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[CULTIST][5][0]; // 0
	entity->focaly = limbs[CULTIST][5][1]; // 0
	entity->focalz = limbs[CULTIST][5][2]; // 2
	entity->behavior = &actCultistLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[CULTIST][6][0]; // 2
	entity->focaly = limbs[CULTIST][6][1]; // 0
	entity->focalz = limbs[CULTIST][6][2]; // -.5
	entity->behavior = &actCultistLimb;
	entity->parent = my->getUID();
	entity->pitch = .25;
	node = list_AddNodeLast(&my->children);
	...
	entity->flags[INVISIBLE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[CULTIST][7][0]; // 0
	entity->focaly = limbs[CULTIST][7][1]; // 0
	entity->focalz = limbs[CULTIST][7][2]; // 1.5
	entity->behavior = &actCultistLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[INVISIBLE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[CULTIST][8][0]; // 0
	entity->focaly = limbs[CULTIST][8][1]; // 0
	entity->focalz = limbs[CULTIST][8][2]; // 4
	entity->behavior = &actCultistLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[CULTIST][9][0]; // 0
	entity->focaly = limbs[CULTIST][9][1]; // 0
	entity->focalz = limbs[CULTIST][9][2]; // -2
	entity->behavior = &actCultistLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
...
void cultistMoveBodyparts(Entity* my, Stat* myStats, double dist)
{
	...
	for (bodypart = 0, node = my->children.first; node != nullptr; node = node->next, ++bodypart)
	{
		...
		{
			my->humanoidAnimateWalk(entity, node, bodypart, CULTISTWALKSPEED, dist, 0.4);
		}
		...
		switch ( bodypart )
		{
			...
			case LIMB_HUMANOID_RIGHTARM:
			{
				...
				if ( weaponNode )
				{
					...
					{
						// else flex arm.
						entity->focalx = limbs[CULTIST][4][0] + 1; // 1
						entity->focaly = limbs[CULTIST][4][1]; // 0
						entity->focalz = limbs[CULTIST][4][2] - 1; // 1
						entity->sprite = 426;
					}
				}
			...
			case LIMB_HUMANOID_LEFTARM:
			{
				...
				if ( shieldNode )
				{
					...
					{
						// else flex arm.
						entity->focalx = limbs[CULTIST][5][0] + 1; // 1
						entity->focaly = limbs[CULTIST][5][1]; // 0
						entity->focalz = limbs[CULTIST][5][2] - 1; // 1
						entity->sprite = 428;
					}
				}
				entity->x -= 2.5 * cos(my->yaw + PI / 2) + .75 * cos(my->yaw);
