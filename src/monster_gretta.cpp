...
void initGretta(Entity* my, Stat* myStats)
{
	...
	//Sprite 1562 = gretta head sprite
	my->initMonster(1562);
	...
	if ( multiplayer != CLIENT && !MONSTER_INIT )
	{
		if ( myStats != nullptr )
		{
			...
			else
			{
				...
				if ( !strncmp(myStats->name, "lesser gretta", strlen("lesser gretta")) )
				{
					lesserMonster = true;
					myStats->HP = 80;
					myStats->MAXHP = myStats->HP;
				...
				// always give special spell to gretta, undroppable.
	...
	// torso
	Entity* entity = newEntity(1563, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	...
	entity->focalx = limbs[GRETTA][1][0]; // 0
	entity->focaly = limbs[GRETTA][1][1]; // 0
	entity->focalz = limbs[GRETTA][1][2]; // 0
	entity->behavior = &actGrettaLimb;
	entity->parent = my->getUID();
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[GRETTA][2][0]; // 1
	entity->focaly = limbs[GRETTA][2][1]; // 0
	entity->focalz = limbs[GRETTA][2][2]; // 2
	entity->behavior = &actGrettaLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[GRETTA][3][0]; // 1
	entity->focaly = limbs[GRETTA][3][1]; // 0
	entity->focalz = limbs[GRETTA][3][2]; // 2
	entity->behavior = &actGrettaLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	*/
	// right arm
	entity = newEntity(1565, 0, map.entities, nullptr); //595 //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[GRETTA][4][0]; // -.25
	entity->focaly = limbs[GRETTA][4][1]; // 0
	entity->focalz = limbs[GRETTA][4][2]; // 1.5
	entity->behavior = &actGrettaLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	// left arm
	entity = newEntity(1564, 0, map.entities, nullptr); //447 //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[GRETTA][5][0]; // -.25
	entity->focaly = limbs[GRETTA][5][1]; // 0
	entity->focalz = limbs[GRETTA][5][2]; // 1.5
	entity->behavior = &actGrettaLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[GRETTA][6][0]; // 
	entity->focaly = limbs[GRETTA][6][1]; // 
	entity->focalz = limbs[GRETTA][6][2]; // 
	entity->behavior = &actGrettaLimb;
	entity->parent = my->getUID();
	entity->pitch = .25;
	node = list_AddNodeLast(&my->children);
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[GRETTA][7][0]; // 
	entity->focaly = limbs[GRETTA][7][1]; // 
	entity->focalz = limbs[GRETTA][7][2]; // 
	entity->behavior = &actGrettaLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[GRETTA][8][0]; // 0
	entity->focaly = limbs[GRETTA][8][1]; // 0
	entity->focalz = limbs[GRETTA][8][2]; // 4
	entity->behavior = &actGrettaLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
