/*-------------------------------------------------------------------------------
	...
	BARONY
	File: monster_ent.cpp
	Desc: implements all of the ent monster's code
...
void initEnt(Entity* my, Stat* myStats)
{
			...
			else
			{
				...
				switch (rand() % 2)
				{
					case 0:					//The Potato King
						...
						for (c = 0; c < 3; c++)
						{
							Entity* entity = summonMonster(ENT, my->x, my->y);
							if (entity)
							{
	...
	// torso
	Entity* entity = newEntity(1542, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	...
	entity->focalx = limbs[ENT][1][0]; // 0
	entity->focaly = limbs[ENT][1][1]; // 0
	entity->focalz = limbs[ENT][1][2]; // 0
	entity->behavior = &actEntLimb;
	entity->parent = my->getUID();
	...
	// right leg
	entity = newEntity(1546, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[ENT][2][0]; // 0
	entity->focaly = limbs[ENT][2][1]; // 0
	entity->focalz = limbs[ENT][2][2]; // 2
	entity->behavior = &actEntLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	// left leg
	entity = newEntity(1545, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[ENT][3][0]; // 0
	entity->focaly = limbs[ENT][3][1]; // 0
	entity->focalz = limbs[ENT][3][2]; // 2
	entity->behavior = &actEntLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	// right arm
	entity = newEntity(1544, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[ENT][4][0]; // 0
	entity->focaly = limbs[ENT][4][1]; // 0
	entity->focalz = limbs[ENT][4][2]; // 1.5
	entity->behavior = &actEntLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	// left arm
	entity = newEntity(1543, 0, map.entities, nullptr); //Limb entity.
	entity->sizex = 4;
	entity->sizey = 4;
	entity->skill[2] = my->getUID();
	entity->flags[PASSABLE] = true;
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[ENT][5][0]; // 0
	entity->focaly = limbs[ENT][5][1]; // 0
	entity->focalz = limbs[ENT][5][2]; // 1.5
	entity->behavior = &actEntLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[ENT][6][0]; // 1.5
	entity->focaly = limbs[ENT][6][1]; // 0
	entity->focalz = limbs[ENT][6][2]; // -.5
	entity->behavior = &actEntLimb;
	entity->parent = my->getUID();
	entity->pitch = .25;
	node = list_AddNodeLast(&my->children);
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[ENT][7][0]; // 2
	entity->focaly = limbs[ENT][7][1]; // 0
	entity->focalz = limbs[ENT][7][2]; // 0
	entity->behavior = &actEntLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[ENT][8][0]; // 0
	entity->focaly = limbs[ENT][8][1]; // 0
	entity->focalz = limbs[ENT][8][2]; // 4
	entity->behavior = &actEntLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[ENT][9][0]; // 0
	entity->focaly = limbs[ENT][9][1]; // 0
	entity->focalz = limbs[ENT][9][2]; // -2
	entity->behavior = &actEntLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
	...
	entity->flags[NOUPDATE] = true;
	entity->flags[USERFLAG2] = my->flags[USERFLAG2];
	entity->focalx = limbs[ENT][10][0]; // 0
	entity->focaly = limbs[ENT][10][1]; // 0
	entity->focalz = limbs[ENT][10][2]; // .25
	entity->behavior = &actEntLimb;
	entity->parent = my->getUID();
	node = list_AddNodeLast(&my->children);
	node->element = entity;
...
void entMoveBodyparts(Entity* my, Stat* myStats, double dist)
{
	...
	for (bodypart = 0, node = my->children.first; node != nullptr; node = node->next, bodypart++)
	{
		...
		{
			my->humanoidAnimateWalk(entity, node, bodypart, ENTWALKSPEED, dist, 0.4);
		}
		...
		switch ( bodypart )
		{
			...
			case LIMB_HUMANOID_TORSO:
				...
				my->setHumanoidLimbOffset(entity, ENT, LIMB_HUMANOID_TORSO);
				break;
			// right leg
			case LIMB_HUMANOID_RIGHTLEG:
				...
				my->setHumanoidLimbOffset(entity, ENT, LIMB_HUMANOID_RIGHTLEG);
				break;
			// left leg
			case LIMB_HUMANOID_LEFTLEG:
				...
				my->setHumanoidLimbOffset(entity, ENT, LIMB_HUMANOID_LEFTLEG);
				break;
			// right arm
			case LIMB_HUMANOID_RIGHTARM:
			{
				...
				if ( weaponNode )
				{
					...
					if ( MONSTER_ARMBENDED || (weapon->flags[INVISIBLE] && my->monsterState == MONSTER_STATE_WAIT) )
					{
						...
						entity->focalx = limbs[ENT][4][0]; // 0
						entity->focaly = limbs[ENT][4][1]; // 0
						entity->focalz = limbs[ENT][4][2]; // 2
						entity->sprite = 178;
					}
					else
					{
						// else flex arm.
						entity->focalx = limbs[ENT][4][0] + 0.75;
						entity->focaly = limbs[ENT][4][1];
						entity->focalz = limbs[ENT][4][2] - 0.75;
						entity->sprite = 179;
					}
				}
				my->setHumanoidLimbOffset(entity, ENT, LIMB_HUMANOID_RIGHTARM);
			...
			case LIMB_HUMANOID_LEFTARM:
			{
				...
				if ( shieldNode )
				{
					...
					if ( shield->flags[INVISIBLE] && my->monsterState == MONSTER_STATE_WAIT )
					{
						entity->focalx = limbs[ENT][5][0]; // 0
						entity->focaly = limbs[ENT][5][1]; // 0
						entity->focalz = limbs[ENT][5][2]; // 2
						entity->sprite = 176;
					}
					else
					{
						entity->focalx = limbs[ENT][5][0] + 0.75;
						entity->focaly = limbs[ENT][5][1];
						entity->focalz = limbs[ENT][5][2] - 0.75;
						entity->sprite = 177;
					}
				}
				my->setHumanoidLimbOffset(entity, ENT, LIMB_HUMANOID_LEFTARM);
			...
			case LIMB_HUMANOID_MASK:
				...
				if ( entity->sprite != 165 )
				{
					...
					{
						entity->focalx = limbs[ENT][10][0] + .35; // .35
						entity->focaly = limbs[ENT][10][1] - 2; // -2
						entity->focalz = limbs[ENT][10][2]; // .25
					}
				}
				else
				{
					entity->focalx = limbs[ENT][10][0] + .25; // .25
					entity->focaly = limbs[ENT][10][1] - 2.25; // -2.25
					entity->focalz = limbs[ENT][10][2]; // .25
				}
				break;
		}
